					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "test_worklist_01",
									"targetURL": "#test_worklist_01-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"test_worklist_01-display": {
								"semanticObject": "test_worklist_01",
								"action": "display",
								"description": "test demo worklist 01",
								"title": "test_worklist_01",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.demo.worklist.test_worklist_01",
									"url": sap.ui.require.toUrl("test/demo/worklist/test_worklist_01")
								}
							}
						}
					}
