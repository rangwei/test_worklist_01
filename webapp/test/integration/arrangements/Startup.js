sap.ui.define([
	"sap/ui/test/Opa5",
	"test/demo/worklist/test_worklist_01/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("test.demo.worklist.test_worklist_01.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "test.demo.worklist.test_worklist_01",
					async: true
				},
				hash: oOptions.hash,
